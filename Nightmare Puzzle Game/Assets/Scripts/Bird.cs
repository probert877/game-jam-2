...
public class Bird : MonoBehaviour
{
    ...
    // click and hold the Bird, change its colors
    ...
    // we want to reset our bird on collision
    ...
    IEnumerator ResetAfterDelay() {
        ...
        // take the bird, reset their position to the _startPosition and become kinematic
